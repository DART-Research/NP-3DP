...
def main():
    ...
    # This part is add for paper writing to get the scalar field
    preprocessor_d=DartPreprocesssor(mesh, parameters, DATA_PATH)
    preprocessor_d.create_compound_targets()
    g_eval=preprocessor_d.create_gradient_evaluation(norm_filename='gradient_norm.json', g_filename='gradient.json',
                                                     target_1=preprocessor.target_LOW,
                                                     target_2=preprocessor.target_HIGH,way='org_gra',show_graph=True)
