    ...
    for i, layer in enumerate(slicer.layers):
        for j, path in enumerate(layer.paths):
            ...
            if align_with == "next_path":
                ...
                pt_to_align_with = {'point':Point(0, 0, 0)}
            elif align_with == "x_axis":
                pt_to_align_with = {'point':Point(2 ** 32, 0, 0)}
            elif align_with == "y_axis":
                pt_to_align_with = {'point':Point(0, 2 ** 32, 0)}
            elif isinstance(align_with, Point):
                pt_to_align_with = {'point':align_with}
            else:
            ...
            if path.is_closed:
                ...
                distance_current_pt_align_pt = [distance_point_point(pt_to_align_with['point'], pt['point']) for pt in path_to_change]
                ...
                d_start = distance_point_point(start['point'], pt_to_align_with['point'])
                d_end = distance_point_point(end['point'], pt_to_align_with['point'])
